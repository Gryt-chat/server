...
const TOKEN_GATES: {
  ...
  { event: "server:channels:scope:follow", permission: "manage_channels", payload: { channelId: "c1" } },
  { event: "server:folders:scope:get", permission: "manage_channels", payload: { folderId: "f1" } },
  { event: "server:folders:scope:set", permission: "manage_channels", payload: { folderId: "f1" } },
